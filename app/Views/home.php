...
<head>
    <meta charset="utf-8">
    <meta name="description" content="Nirwana Education - HTML5 Bootstrap Template">
    ...
    <meta name="msapplication-TileImage" content="<?php echo base_url() ?>/assets/favicons/ms-icon-144x144.png"><!-- PWA primary color-->
    ...
    <meta property="twitter:image:src" content="<?php echo base_url() ?>/assets/images/logo-education.png">
    <meta property="og:url" content="nirwana.indisains.com/education">
    <meta property="og:title" content="Education">
    <meta property="og:description" content="Nirwana Education - HTML5 Bootstrap Template">
    <meta name="twitter:site" content="nirwana.indisains.com/education">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:image" content="/images/logo-education.png">
    <meta property="og:image" content="/images/logo-education.png">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <title>Perpustakaan SMK 4 KENDARI - Homepage </title><!-- Styles-->
    <!-- Put the 3rd/plugins css here-->
    <link href="<?php echo base_url() ?>/assets/css/vendors/normalize.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/css/vendors/bootstrap.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/css/vendors/magnific-popup.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/css/vendors/materialize.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/css/vendors/hamburger-menu.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/css/vendors/animate.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/css/vendors/animate-extends.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/css/vendors/slick-carousel/slick.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/css/vendors/slick-carousel/slick-theme.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/css/styles.css" rel="stylesheet">
</head>

<body>
    <div id="preloader" style="position: fixed; z-index: 10000; background: #fafafa; width: 100%; height: 100%"><img style="opacity: 0.2; position: fixed; top: calc(50% - 50px); left: calc(50% - 50px)" src="<?php echo base_url() ?>/assets/images/loading.gif" alt="loading"></div>
            ...
            <div id="home">
                <div class="main-wrap">
                        ...
                        <div class="side-multilv">
                            <div class="collection side-multilv">
                                <ul class="collapsible expandable">
                                    <li class="collection-item"><a class="sidenav-close waves-effect menu-list" href="#feature">main feature</a></li>
                                    <li class="collection-item"><a class="sidenav-close waves-effect menu-list" href="#popular">popular course</a></li>
                                    <li class="collection-item"><a class="sidenav-close waves-effect menu-list" href="#explore">explore</a></li>
                                    <li class="collection-item"><a class="sidenav-close waves-effect menu-list" href="#blog-home">blog</a></li>
                        ...
                        <div class="container">
                            <div class="header-content">
                                <nav class="nav-menu">
                                    ...
                                    <div class="logo">
                                        <a href="index.html">
                                            <span class="logo-main landscape medium"><img src="<?php echo base_url() ?>/assets/images/logo-education.png" alt="logo" />E-Learn</span>
                                        </a>
                                    </div>
                                    <div class="scrollactive-nav scrollnav show-lg-up multi-menu">
                                        <ul class="main-menu">
                                            <li>
                                                <a class="btn btn-flat anchor-link waves-effect" href="#feature">main feature</a>
                                            </li>
                                            <li>
                                                <a class="btn btn-flat anchor-link waves-effect" href="#popular">popular course</a>
                                            </li>
                                            <li>
                                                <a class="btn btn-flat anchor-link waves-effect" href="#explore">explore</a>
                                            </li>
                                            <li>
                                                <a class="btn btn-flat anchor-link waves-effect" href="#blog-home">blog</a>
                                            </li>
                                            <li>
                                                        ...
                                                        <div class="container max-md">
                                                            <div class="row">
                                                                <div class="col-sm-3 mb-6">
                                                                    <div class="title-mega">Company</div>
                                                                    <img class="thumb-menu" src="<?php echo base_url() ?>/assets/images/education/menu_marketing@2x.jpg" alt="thumbnail" />
                                                                    <ul>
                                                                ...
                                                                <div class="col-sm-3 mb-6">
                                                                    <div class="title-mega">Form</div>
                                                                    <img class="thumb-menu" src="<?php echo base_url() ?>/assets/images/education/menu_education@2x.jpg" alt="thumbnail" />
                                                                    <ul>
                                                                ...
                                                                <div class="col-sm-3 mb-6">
                                                                    <div class="title-mega">Items</div>
                                                                    <img class="thumb-menu" src="<?php echo base_url() ?>/assets/images/education/menu_pos@2x.jpg" alt="thumbnail" />
                                                                    <ul>
                                                                ...
                                                                <div class="col-sm-3 mb-6">
                                                                    <div class="title-mega">Utilities</div>
                                                                    <img class="thumb-menu" src="<?php echo base_url() ?>/assets/images/education/menu_saas2@2x.jpg" alt="thumbnail" />
                                                                    <ul>
                    ...
                    <main class="container-wrap">
                        ...
                        <section id="banner">
                            <div class="banner-slider">
                                <div class="banner-wrap">
                                    ...
                                    <div class="container small-deco">
                                        <div></div>
                                    </div>
                                    <div class="carousel">
                                        <div class="slider" id="banner_slider">
                                            <div class="slide" id="slide1">
                                                <div class="inner">
                                                    <div class="img background-banner">
                                                        <img class="img-2d3d" src="<?php echo base_url() ?>/assets/images/education/background_2d@2x.png" data-2d="<?php echo base_url() ?>/assets" data-3d="<?php echo base_url() ?>/assets/images/education/background_2d@2x.png" alt="background" />
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-12 px-sm-4 px-0 d-flex align-center">
                                                                <div class="text">
                                                                    <div class="title title-left">
                                                                        <h4 class="use-text-title">Upgrade Yourself</h4>
                                                                    </div>
                                                                    <h5 class="use-text-subtitle">Anywhere, anytime. Start learning today! And Get an Exceptional Education Experience.</h5>
                                                                    <div class="btn-area">
                                                                        <a class="btn-flat waves-effect btn-large button primary-text" href="#">see detail</a>
                                                                        <a class="btn waves-effect button btn-large primary" href="register.html">get started</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 col-sm-12 px-6">
                                                                <div class="img">
                                                                    <img class="img-2d3d img-slide1" src="<?php echo base_url() ?>/assets/images/education/banner1_2d@2x.png" data-2d="<?php echo base_url() ?>/assets" data-3d="<?php echo base_url() ?>/assets/images/education/banner1_2d@2x.png" alt="banner 1 3D" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="slide" id="slide2">
                                                <div class="inner">
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-md-7 col-lg-6 col-sm-12 px-sm-4 px-0 d-flex align-items-center order-lg-5">
                                                                <div class="text">
                                                                    <h4 class="use-text-title">Upgrade Yourself</h4>
                                                                    <h5 class="use-text-subtitle">Anywhere, anytime. Start learning today! And Get an Exceptional Education Experience.</h5>
                                                                    <div class="btn-area">
                                                            ...
                                                            <div class="col-md-5 col-lg-6 col-sm-12 order-lg-0">
                                                                <div class="img">
                                                                    <img class="img-2d3d img-slide2" src="<?php echo base_url() ?>/assets/images/education/banner2_2d@2x.png" data-2d="<?php echo base_url() ?>/assets" data-3d="<?php echo base_url() ?>/assets/images/education/banner2_2d@2x.png" alt="banner 2 3D" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row justify-content-end">
                                                            <div class="col-12 px-lg-12 px-0">
                                                                <div class="text text-center">
                                                                    ...
                                                                    <h5 class="use-text-subtitle">Anywhere, anytime. Start learning today! And Get an Exceptional Education Experience.</h5>
                                                                    <div class="btn-area">
                                                                        <a class="btn-flat waves-effect btn-large button" href="#">see detail</a>
                                                                        <a class="btn waves-effect button btn-large primary" href="register.html">get started</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="img h-banner">
                                                                    <img class="img-2d3d" src="<?php echo base_url() ?>/assets/images/education/banner3_2d@2x.png" data-2d="<?php echo base_url() ?>/assets" data-3d="<?php echo base_url() ?>/assets/images/education/banner3_2d@2x.png" alt="banner 3 3D" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <!-- ##### FEATURE #####-->
                        <section class="space-top space-top-short-sm" id="feature">
                            <div class="root">
                                <div class="container max-md">
                                    ...
                                    <div class="row spacing8 grid">
                                        <div class="col-sm-6 px-6 py-3">
                                            <div class="counter-item">
                                                <figure>
                                                    <img class="img-2d3d img-2d3d" src="<?php echo base_url() ?>/assets/images/education/feature1_2d@2x.png" data-2d="<?php echo base_url() ?>/assets" data-3d="<?php echo base_url() ?>/assets/images/education/feature1_2d@2x.png" alt="feature" />
                                                </figure>
                                                <div class="text">
                                        ...
                                        <div class="col-sm-6 px-6 py-3">
                                            <div class="counter-item">
                                                <figure>
                                                    <img class="img-2d3d img-2d3d" src="<?php echo base_url() ?>/assets/images/education/feature2_2d@2x.png" data-2d="<?php echo base_url() ?>/assets" data-3d="<?php echo base_url() ?>/assets/images/education/feature2_2d@2x.png" alt="feature" />
                                                </figure>
                                                <div class="text">
                                                    <h4 class="use-text-title">
                                        ...
                                        <div class="col-sm-6 px-6 py-3">
                                            <div class="counter-item">
                                                <figure>
                                                    <img class="img-2d3d img-2d3d" src="<?php echo base_url() ?>/assets/images/education/feature3_2d@2x.png" data-2d="<?php echo base_url() ?>/assets" data-3d="<?php echo base_url() ?>/assets/images/education/feature3_2d@2x.png" alt="feature" />
                                                </figure>
                                                <div class="text">
                                                    <h4 class="use-text-title">
                                        ...
                                        <div class="col-sm-6 px-6 py-3">
                                            <div class="counter-item">
                                                <figure>
                                                    <img class="img-2d3d img-2d3d" src="<?php echo base_url() ?>/assets/images/education/feature4_2d@2x.png" data-2d="<?php echo base_url() ?>/assets" data-3d="<?php echo base_url() ?>/assets/images/education/feature4_2d@2x.png" alt="feature" />
                                                </figure>
                                                <div class="text">
                            ...
                            <div class="root">
                                <div class="container carousel-header">
                                    <div class="title-main align-left">
                                        <h4 class="secondary"><span>Popular Course</span></h4>
                                        <p class="desc use-text-subtitle2">Choose from many options of popular course at a breakthrough price.</p>
                                    </div>
                                    <a class="btn-flat waves-effect primary-text view-all" href="products.html">see all<i class="material-icons icon">arrow_forward</i></a>
                                </div>
                                <div class="container">
                                    <div class="floating-artwork">
                                        <div class="slider-art">
                                            <div class="deco">
                                                <div class="figure show-md-up" id="art_course">
                                                    <div class="wow fadeInRightShort" data-wow-offset="60" data-wow-delay="0.3s" data-wow-duration="0.5s">
                                                        <img class="img-2d3d img-2d3d" src="<?php echo base_url() ?>/assets/images/education/popular_2d@2x.png" data-2d="<?php echo base_url() ?>/assets" data-3d="<?php echo base_url() ?>/assets/images/education/popular_2d@2x.png" alt="popular course" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="slider-wrap">
                                    <div class="carousel">
                                        <div class="slick-carousel" id="course_carousel" data-length="6">
                                            ...
                                            <div class="item">
                                                <div class="card product-card portrait round">
                                                    <a class="waves-effect hidden-link" href="product-detail.html">&nbsp;</a>
                                                    <div class="figure">
                                                        <div class="responsive-img" style="background-image:url(https://placehold.co/270x320/189a96/FFFFFF);"></div>
                                                    </div>
                                                    <div class="desc">
                                                        <div class="text">
                                                            <h6 class="title pb-2 text-truncate">Instant Kendo UI Mobile</h6>
                                                        ...
                                                        <div>
                                                            ...
                                                            <a class="btn btn-outlined primary button block waves-effect" href="product-detail.html">see detail</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="card product-card portrait round">
                                                    ...
                                                    <div class="desc">
                                                        <div class="text">
                                                            <h6 class="title pb-2 text-truncate">Joy of Cooking</h6>
                                            ...
                                            <div class="item">
                                                <div class="card product-card portrait round">
                                                    ...
                                                    <div class="desc">
                                                        <div class="text">
                                                            <h6 class="title pb-2 text-truncate">Face the Music: A Life Exposed</h6>
                                            ...
                                            <div class="item">
                                                <div class="card product-card portrait round">
                                                    ...
                                                    <div class="desc">
                                                        <div class="text">
                                                            <h6 class="title pb-2 text-truncate">Metaverse For Beginners</h6>
                                            ...
                                            <div class="item">
                                                <div class="card product-card portrait round">
                                                    ...
                                                    <div class="desc">
                                                        <div class="text">
                                                            <h6 class="title pb-2 text-truncate">Practical Ethics in Sport Management</h6>
                                            ...
                                            <div class="item">
                                                <div class="card product-card portrait round">
                                                    ...
                                                    <div class="desc">
                                                        <div class="text">
                                                            <h6 class="title pb-2 text-truncate">Economic Geography: Past, Present and Future</h6>
                                        ...
                                        <button class="btn-floating nav prev waves-effect" id="prev_project" type="button">
                                            <i class="ion-ios-arrow-back"></i>
                                        </button>
                                        <button class="btn-floating nav next waves-effect" id="next_project" type="button">
                            ...
                            <div class="root">
                                <div class="container">
                                    <div class="px-lg-6">
                                        ...
                                        <div class="rack" id="cat1">
                                            <div class="category-title">
                                                <h3><i class="material-icons small">palette</i>&nbsp; Lorem Ipsum</h3>
                                                <a class="btn-flat waves-effect primary-text view-all" href="products.html">see all<i class="material-icons icon">arrow_forward</i></a>
                                            </div>
                                            <div class="content">
                                                <div class="book collapsed" style="border: 2px solid #f74e10">
                                                    <figure>
                                                        <img src="https://placehold.co/270x320/189a96/FFFFFF" alt="title" />
                                                        <figcaption style="background: #f74e10">
                                                            <span>Interiors Beyond Architecture</span>
                                                        </figcaption>
                                                    </figure>
                                                    <div class="desc">
                                                        <div class="text">
                                                            <h6 class="title pb-2 text-truncate">Interiors Beyond Architecture</h6>
                                                            <p class="use-text-paragraph">The overall premise of the book is to learn Revit Architecture while developing the interior of a two story law office</p>
                                                        </div>
                                                        <div>
                                                            <div class="property">
                                                                <div class="rating"><i class="material-icons star-icon" title="1">star</i><i class="material-icons star-icon" title="2">star</i><i class="material-icons star-icon" title="3">star</i><i class="material-icons star-icon" title="4">star</i><i class="material-icons star-icon" title="5">star</i></div><strong>$50</strong>
                                                            </div>
                                                            <a class="btn btn-outlined primary button block" href="product-detail.html">see detail</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="book collapsed" style="border: 2px solid #c7618c">
                                                    <figure>
                                                        <img src="https://placehold.co/270x320/189a96/FFFFFF" alt="title" />
                                                    ...
                                                    <div class="desc">
                                                        <div class="text">
                                                            <h6 class="title pb-2 text-truncate">Modern Art</h6>
                                                            <p class="use-text-paragraph">The works stand out for being an intellectual painter in the creation of the pictorial work from scratch</p>
                                                        </div>
                                                        <div>
                                                            <div class="property">
                                                                <div class="rating"><i class="material-icons star-icon" title="1">star</i><i class="material-icons star-icon" title="2">star</i><i class="material-icons star-icon" title="3">star</i><i class="material-icons star-icon" title="4">star</i><i class="material-icons star-icon-disable" title="1">star</i></div><strong>$10</strong>
                                                ...
                                                <div class="book collapsed" style="border: 2px solid #e59546">
                                                    <figure>
                                                        <img src="https://placehold.co/270x320/189a96/FFFFFF" alt="title" />
                                                        <figcaption style="background: #e59546">
                                                            <span>Joy of Cooking</span>
                                                        </figcaption>
                                                    </figure>
                                                    <div class="desc">
                                                        <div class="text">
                                                ...
                                                <div class="book expanded" style="border: 2px solid #8f46e5">
                                                    <figure>
                                                        <img src="https://placehold.co/270x320/189a96/FFFFFF" alt="title" />
                                                        <figcaption style="background: #8f46e5">
                                                            <span>Metaverse For Beginners</span>
                                                        </figcaption>
                                                    </figure>
                                                    <div class="desc">
                                                        <div class="text">
                                                ...
                                                <div class="book collapsed" style="border: 2px solid #ac8a55">
                                                    <figure>
                                                        <img src="https://placehold.co/270x320/189a96/FFFFFF" alt="title" />
                                                        <figcaption style="background: #ac8a55">
                                                            <span>Face the Music</span>
                                                        </figcaption>
                                                    </figure>
                                                    <div class="desc">
                                                        <div class="text">
                                                            <h6 class="title pb-2 text-truncate">Face the Music</h6>
                                                            <p class="use-text-paragraph">Face the Music is the shocking inspirational story of one of rock’s most enduring icons.</p>
                                                        </div>
                                                        <div>
                                                            <div class="property">
                                                ...
                                                <div class="book collapsed" style="border: 2px solid #274be3">
                                                    <figure>
                                                        <img src="https://placehold.co/270x320/189a96/FFFFFF" alt="title" />
                                                        <figcaption style="background: #274be3">
                                                            <span>Key Concepts in Geography</span>
                                                        </figcaption>
                                                    </figure>
                                                    <div class="desc">
                                                        <div class="text">
                                                            <h6 class="title pb-2 text-truncate">Key Concepts in Geography</h6>
                                                            <p class="use-text-paragraph">This book clearly outlines key concepts that all geographers should readily be able to explain</p>
                                                        </div>
                                                        <div>
                                                            <div class="property">
                                                                <div class="rating"><i class="material-icons star-icon" title="1">star</i><i class="material-icons star-icon" title="2">star</i><i class="material-icons star-icon" title="3">star</i><i class="material-icons star-icon" title="4">star</i><i class="material-icons star-icon" title="5">star</i></div><strong>$40</strong>
                                                ...
                                                <div class="book collapsed" style="border: 2px solid #6DB4A7">
                                                    <figure>
                                                        <img src="https://placehold.co/270x320/189a96/FFFFFF" alt="title" />
                                                        <figcaption style="background: #6DB4A7">
                                                            <span>On Photography</span>
                                                        </figcaption>
                                                    </figure>
                                                    <div class="desc">
                                                        <div class="text">
                                                            <h6 class="title pb-2 text-truncate">On Photography</h6>
                                                            <p class="use-text-paragraph">Photographs are everywhere and it has profoundly altered our relationship with the world.</p>
                                                        </div>
                                                        <div>
                                                            <div class="property">
                                                                <div class="rating"><i class="material-icons star-icon" title="1">star</i><i class="material-icons star-icon" title="2">star</i><i class="material-icons star-icon" title="3">star</i><i class="material-icons star-icon" title="4">star</i><i class="material-icons star-icon" title="5">star</i></div><strong>$50</strong>
                                        ...
                                        <div class="rack" id="cat2">
                                            <div class="category-title">
                                                <h3><i class="material-icons small">brightness_low</i>&nbsp; Lorem Ipsum</h3>
                                                <a class="btn-flat waves-effect primary-text view-all" href="products.html">see all<i class="material-icons icon">arrow_forward</i></a>
                                            </div>
                                            <div class="content">
                                                <div class="book collapsed" style="border: 2px solid #f74e10">
                                                ...
                                                <div class="book expanded" style="border: 2px solid #e59546">
                                                    <figure>
                                                        <img src="https://placehold.co/270x320/189a96/FFFFFF" alt="title" />
                                                        <figcaption style="background: #e59546">
                                                            <span>Joy of Cooking</span>
                                                ...
                                                <div class="book collapsed" style="border: 2px solid #8f46e5">
                                                    <figure>
                                                        <img src="https://placehold.co/270x320/189a96/FFFFFF" alt="title" />
                                                        <figcaption style="background: #8f46e5">
                                                            <span>Metaverse For Beginners</span>
                                        ...
                                        <div class="rack mb-10" id="cat3">
                                            <div class="category-title">
                                                <h3><i class="material-icons small">language</i>&nbsp; Lorem Ipsum</h3>
                                                <a class="btn-flat waves-effect primary-text view-all" href="products.html">see all<i class="material-icons icon">arrow_forward</i></a>
                                            </div>
                                            <div class="content">
                                                <div class="book collapsed" style="border: 2px solid #f74e10">
                                                ...
                                                <div class="book expanded" style="border: 2px solid #6DB4A7">
                                                    <figure>
                                                        <img src="https://placehold.co/270x320/189a96/FFFFFF" alt="title" />
                                                        <figcaption style="background: #6DB4A7">
                                                            <span>On Photography</span>
                        ...
                        <!-- ##### ABOUT #####-->
                        <section class="space-top-short" id="about">
                            <div class="root">
                                <div class="container fixed-width">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12 illu-wrap">
                                            <div class="wow fadeInLeftShort" data-wow-offset="-100" data-wow-delay="0.2s" data-wow-duration="0.6s">
                                                <div class="illustration">
                                                    <img class="img-2d3d" src="<?php echo base_url() ?>/assets/images/education/about_2d@2x.png" data-2d="<?php echo base_url() ?>/assets" data-3d="<?php echo base_url() ?>/assets/images/education/about_2d@2x.png" alt="about" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                            <div class="text-lg-start text-center">
                                                <div class="title-main align-left">
                                                    <h4 class="secondary"><span>About us</span></h4>
                                                    <p class="desc use-text-subtitle2">Our mission is to diversify the tech industry through accessible education and apprenticeship, unlocking the door to opportunity and empowering people to achieve their dreams.</p>
                                                </div>
                                                <a class="btn secondary waves-effect" href="login.html">Join Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="slick-carousel" id="testimonial_carousel">
                                            <div class="item">
                                                <div class="testimonial-card">
                                                    ...
                                                    <p class="text">Vivamus sit amet interdum elit. Proin lacinia erat ac velit tempus auctor. Interdum et malesuada fames ac ante ipsum primis in faucibus. Aliquam nec ex aliquet, aliquam neque non.</p>
                                                    <h6>John Doe</h6>
                                            ...
                                            <div class="item">
                                                <div class="testimonial-card">
                                                    <div class="icon"><span></span></div>
                                                    <p class="text">Vestibulum sit amet tortor sit amet libero lobortis semper at et odio. In eu tellus tellus. Pellentesque ullamcorper aliquet ultrices. Aenean facilisis vitae purus facilisis semper. Nam vitae scelerisque lorem, quis tempus libero.</p>
                                                    <h6>Jean Doe</h6>
                                                    <p class="caption">Chief Digital Officer</p>
                                                </div>
                                            </div>
                                            <div class="item">
                                                <div class="testimonial-card">
                                                    <div class="icon"><span></span></div>
                                                    <p class="text">Cras convallis lacus orci, tristique tincidunt magna consequat in. In vel pulvinar est, at euismod libero.</p>
                                                    <h6>Jena Doe</h6>
                                            ...
                                            <div class="item">
                                                <div class="testimonial-card">
                                                    <div class="icon"><span></span></div>
                                                    <p class="text">Sed imperdiet enim ligula, vitae viverra justo porta vel.</p>
                                                    <h6>Jovelin Doe</h6>
                        ...
                        <!-- ##### BLOG #####-->
                        <section class="space-top" id="blog-home">
                            <div class="root">
                                <div class="modal video-popup" id="video_modal_blog">
                                    ...
                                    <div class="row flex-sm-row-reverse">
                                        <div class="col-md-6 col-sm-12 pa-md-8 pa-0">
                                            <div class="video-wrap">
                                                <div class="video-carousel">
                                                    <div class="card item">
                                                        <img src="https://placehold.co/700x462/8e8e8e/FFFFFF" alt="cover" />
                                                        <button class="btn play-btn waves-effect modal-trigger" data-target="video_modal_blog">
                                        ...
                                        <div class="col-md-6 col-sm-12 pa-md-8 pa-2">
                                            <div class="blog-list">
                                                <div class="wow fadeInLeftShort" data-wow-offset="-200" data-wow-delay="0s" data-wow-duration="0.6s">
                                                    <div class="blog-card">
                                                        <div class="text">
                                                            ...
                                                            <h4>
                                                                <a class="btn-flat waves-effect" href="#">Vestibulum vitae tristique urna. Mauris non cursus quam</a>
                                                            </h4>
                                                        </div>
                                                        <div class="date">
                                                            <h3>Feb</h3>
                                                ...
                                                <a class="more secondary-text btn-flat waves-effect">more</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section class="bottom-deco-wrap space-top" id="subscribe">
                        <div class="footer-top-deco">
                            <div class="wow zoomInShort" data-wow-offset="0" data-wow-delay="0.2s" data-wow-duration="0.3s">
                                <img class="img-2d3d" src="<?php echo base_url() ?>/assets/images/education/footer_2d@2x.png" data-2d="<?php echo base_url() ?>/assets" data-3d="<?php echo base_url() ?>/assets/images/education/footer_2d@2x.png" alt="footer" />
                            </div>
                        </div>
                        <div class="subsribe-form">
                            <div class="root">
                                <div class="container max-sm">
                                    <h3 class="use-text-title2 mb-4">Subscribe our newsletter</h3>
                                    <p class="use-text-subtitle2">Subscribe our newsletter</p>
                                    <div class="form">
                                        <form>
                                            <div class="field outlined">
                                                <div class="input-field dark full-width solo">
                                                    <input type="email" name="email" placeholder="What is your email? *" />
                                                </div>
                                            </div>
                                            <button class="btn primary button waves-effect" type="button">Subscribe</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                    ...
                    <footer class="footer-sitemap">
                        <div class="footer-bottom-deco">
                            <div class="left-deco">
                                <img class="img-2d3d" src="<?php echo base_url() ?>/assets/images/education/footer_plant_2d@2x.png" data-2d="<?php echo base_url() ?>/assets" data-3d="<?php echo base_url() ?>/assets/images/education/footer_plant_2d@2x.png" alt="footer" />
                            </div>
                            <div class="right-deco">
                                <img class="img-2d3d" src="<?php echo base_url() ?>/assets/images/education/footer_plant2_2d@2x.png" data-2d="<?php echo base_url() ?>/assets" data-3d="<?php echo base_url() ?>/assets/images/education/footer_plant2_2d@2x.png" alt="footer" />
                            </div>
                        </div>
                        <div class="container mq-sm-down" data-class="fixed-width">
                            <div class="row">
                                <div class="col-md-3 col-sm-12 pa-lg-4 logo-area">
                                    ...
                                    <p class="body-2">Anywhere, anytime. Start learning today! And Get an Exceptional Education Experience.</p>
                        ...
                        <div class="notification alert alert-dismissible fade show" role="alert">
                            <div class="wrapper">
                                <div class="content">
                                    ...
                                    <button class="btn secondary waves-effect waves-light" type="button" data-bs-dismiss="alert" aria-label="Close">Accept</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="panel" id="chat_panel">
                                ...
                                <div class="chat-room" id="chat-container">
                                    <ul>
                                        <li class="item">
                                            <div class="avatar">
                                                <img class="avatar-img" src="<?php echo base_url() ?>/assets/images/avatars/pp_boy4.svg" alt="visitor" />
                                            </div>
    ...
    <script src="<?php echo base_url() ?>/assets/js/vendors/enquire.min.js"></script>
    <script src="<?php echo base_url() ?>/assets/js/vendors/jquery.form-validator.min.js"></script>
    <script src="<?php echo base_url() ?>/assets/js/vendors/jquery.touchSwipe.min.js"></script>
    <script src="<?php echo base_url() ?>/assets/js/vendors/jquery.magnific-popup.min.js"></script>
    <script src="<?php echo base_url() ?>/assets/js/vendors/pace.min.js"></script>
    <script src="<?php echo base_url() ?>/assets/js/vendors/slick.min.js"></script>
    <script src="<?php echo base_url() ?>/assets/js/vendors/wow.min.js"></script>
    <script src="<?php echo base_url() ?>/assets/js/vendors/jquery.navScroll.min.js"></script><!-- This assets are not avalaible in npm.js or it has been costumized-->
    <script src="<?php echo base_url() ?>/assets/js/vendors/modernizr-2.8.3-respond-1.4.2.min.js"></script>
    <script src="<?php echo base_url() ?>/assets/js/vendors/materialize.js"></script>
